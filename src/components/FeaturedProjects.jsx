...
function FeaturedProjects() {
  ...
  if (projectsError) {
    return (
      <div className="featured-projects error">Failed to load projects.</div>
    );
  }
                  ...
                  const getLanguageIcon = (language) => {
                    ...
                    switch (langLower) {
                      ...
                      case "js":
                        return {
                          icon: "bi-filetype-js",
                          color: "var(--lang-js, #f7df1e)",
                        };
                      case "typescript":
                      case "ts":
                        return {
                          icon: "bi-filetype-tsx",
                          color: "var(--lang-ts, #3178c6)",
                        };
                      case "react":
                        return {
                          icon: "bi-filetype-jsx",
                          color: "var(--lang-react, #61dafb)",
                        };
                      case "python":
                        return {
                          icon: "bi-filetype-py",
                      ...
                      case "java":
                        return {
                          icon: "bi-cup-hot",
                          color: "var(--lang-java, #ed8b00)",
                        };
                      case "html":
                        return {
                          icon: "bi-filetype-html",
                          color: "var(--lang-html, #e34f26)",
                        };
                      case "css":
                        return {
                          icon: "bi-filetype-css",
                          color: "var(--lang-css, #1572b6)",
                        };
                      case "node.js":
                      case "nodejs":
                        return {
                          icon: "bi-braces",
                          color: "var(--lang-node, #339933)",
                        };
                      case "php":
                        return {
                          icon: "bi-filetype-php",
                          color: "var(--lang-php, #777bb4)",
                        };
                      case "c++":
                        return {
                          icon: "bi-file-code",
                          color: "var(--lang-cpp, #00599c)",
                        };
                      case "c#":
                        return {
                          icon: "bi-file-code",
                          color: "var(--lang-csharp, #239120)",
                        };
                      default:
                        return {
                          icon: "bi-code-slash",
